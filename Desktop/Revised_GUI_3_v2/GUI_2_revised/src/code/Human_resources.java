...
public class Human_resources {
	...
	public  Database data3 = new Database();;
	public Scanner in;
	...
	private void initialize() {
		...
		textPane.setBounds(270, 249, 181, 70);
		int index = 0;
		for (index = 0; index < data3.member.size(); index++) {
			if (data3.member.get(index) == textField.getText()) {
				textPane.setText(data3.member.get(index));
			}
		}
