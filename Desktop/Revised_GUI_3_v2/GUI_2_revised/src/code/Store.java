...
public class Store extends JFrame {
	...
	private void initialize() {
		...
		product.add(0,"Salmon_sushi_25_bahts");
		product.add(1,"Tuna_sushi_30_bahts");
		product.add(2,"Salmon_usuzukuri_169_bahts");
		product.add(3,"Tuna_usuzukuri_179_bahts");
		product.add(4,"Green_tea_20_bahts");
