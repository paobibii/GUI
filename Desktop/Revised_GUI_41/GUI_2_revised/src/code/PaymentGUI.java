...
public class PaymentGUI {
    ...
    int debt =  Integer.parseInt(shop2.textField.getText()) * 25;
	int debt1 = Integer.parseInt(shop2.textField_1.getText()) * 30;
	int debt2 = Integer.parseInt(shop2.textField_2.getText()) * 169;
	int debt3 = Integer.parseInt(shop2.textField_3.getText()) * 189;
	int debt4 = Integer.parseInt(shop2.textField_4.getText()) * 20;
